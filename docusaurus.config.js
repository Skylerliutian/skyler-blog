  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `<p>Copyright © ${new Date().getFullYear()} Skyler, Inc. Built with Docusaurus.</p><p><a href="http://beian.miit.gov.cn/" >京ICP备2022025344号-1</a></p> <br />本站所有内容遵循 <a rel="license" href="https://creativecommons.org/licenses/by-nc/4.0/deed.zh-Hans" >CC BY-NC 4.0 协议</a>，转载须注明署名和出处，且不可用于商业用途。若与其他同步平台协议冲突，以本网站为准。`,
      },
      prism: {
